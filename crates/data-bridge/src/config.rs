//! Global security configuration for data-bridge
//!
...
//! # Usage
//! ```python
//! from data_bridge import configure_security, ObjectIdConversionMode
//!
...
/// # Examples
/// ```python
/// from data_bridge import get_security_config
///
