"""
data_bridge.test - Custom Python test framework with Rust engine
...
Benchmark example:
    from data_bridge.test import benchmark, compare_benchmarks
...
# The Rust module is at data_bridge.data_bridge (the .so file)
